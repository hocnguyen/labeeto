...
<div class="row grey-info-block text-center">
    <div class="container">
        <h2 class="page_title"><span>Why Choose US ?</span><br />
            <span class="sep"></span></h2>
        <div class="col-md-4"> <img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/labee/meet_people.png" alt="image" class="img-rounded img-responsive">
        ...
        <div class="col-md-4"> <img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/labee/find_love.png" alt="image" class="img-rounded img-responsive">
        ...
        <div class="col-md-4"> <img src="<?php echo Yii::app()->themeManager->baseUrl; ?>/labee/get_fit.png" alt="image" class="img-rounded img-responsive">
