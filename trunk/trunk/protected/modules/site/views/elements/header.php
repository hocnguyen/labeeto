<div class="container">
    ...
    <?php if(!Yii::app()->user->isGuest){ ?>
        vinhtq
    <a href="<?php echo $this->createUrl('/logout/index'); ?>" class="deleteSessionAjax" style="color: #A10EA1;"><?php echo Yii::t('global', '(Logout)'); ?></a>
...
<div id="facebook-fancybox" class="facebook-fancybox">
    ...
    <div class="inner-fancybox">
        <div class="inner-wrapper">
            <?php echo CHtml::form($this->createUrl('/login'), 'post', array('class'=>'frmcontact', 'id'=>'fancybox-form')); ?>
