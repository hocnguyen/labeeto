...
<div class="table">
	<div class="custompagecontent">
		...
		<?php echo CHtml::form($this->createUrl('users/verify'), 'post', array('class'=>'frmcontact', 'id'=>'validation2')); ?>
			...
			<div class="row-fluid">
				<div class="span3 bold"><label for="veri_email"><?php echo Yii::t('global','Email:')?></label> *</div>
			...
			<div class="row-fluid">
				<div class="span3 bold"><label for="veri_code"><?php echo Yii::t('global','Code:')?></label> *</div>
