...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Article Comments'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('productComments/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
