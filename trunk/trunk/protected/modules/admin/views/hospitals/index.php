...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('hospitals/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
		...
		'city',
        array(
            'name'=>'center_for_laryngectomy',
            'value'=>'Press::getStatusPress($data->center_for_laryngectomy)',
            'filter'=>$status,
        ),
        array(
            'name' => 'created',
