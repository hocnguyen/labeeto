...
<div class="span12">
    <div class="containerHeadline">
        <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','agencies-category'); ?></h2>
    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <div class="control-group">
                <label for="fullname" class="control-label"><?php echo Yii::t('global','Description'); ?>
                </label>
                <div class="controls">
                    <?php echo $form->textField($model,'type',array('size'=>60,'maxlength'=>255, 'class'=>'span10')); ?>
                </div>
            </div>
