...
<div class="span12">
    <div class="containerHeadline">
        <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','video-comments'); ?></h2>
    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <label for="fullname" class="control-label"><?php echo $form->labelEx($model,'video_id'); ?>
</label>
                    <div class="controls">
                        <?php
                            $listVideos  = CHtml::listData(Videos::model()->findAll(),'id','title');
                            echo $form->dropDownList($model,'video_id', $listVideos);
                        ?>
                    </div>
                </div>
                            <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        $list = CHtml::listData(VideoComments::model()->findAllByAttributes($condition, $criteria ), 'id', 'subject' );
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'VideoComments[content]', 'value' => isset($model->content) ? $model->content : '', 'editorTemplate' => 'full' )); ?>
                    </div>
                </div>
                <div class="control-group">
