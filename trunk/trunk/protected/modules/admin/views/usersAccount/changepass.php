<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="containerHeadline tableHeadline">
                <h2><?php echo Yii::t('global', 'Change Password').' ['.$member->login.']'; ?></h2>
                <form>
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        	...
        	<div class="row-form clearfix">
        		...
        		<div class="span9">
                    <?php echo $form->passwordField($password,'npassword',array('class'=>'validate[minSize[8]]','size'=>60,'maxlength'=>155, 'data-required'=>'true')); ?>
        	...
        	<div class="row-form clearfix">
        		...
        		<div class="span9">
                    <?php echo $form->passwordField($password,'npassword2', array( 'data-required'=>'true')); ?>
