...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('agencies/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'advertisers',
            'value'=>'Agencies::getStatus( $data->advertisers )',
            'filter'=>$advertiser,
        ),
        array(
          'name'=>'email_1',
