...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Audios Comments'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('audiosComments/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            ...
            'type' => 'raw',
            'filter'=>$active_news,
            'value' => '$data->getStatusAudiosComments( $data->is_active )',
