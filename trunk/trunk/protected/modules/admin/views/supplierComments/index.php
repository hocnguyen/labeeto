...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('supplierComments/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
