...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important">
       ...
       <small><?php echo Yii::t('global', 'SupplierComments'); ?> #<?php echo $model->id; ?></small></h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline tableHeadline">
                ...
                <h2><?php echo Yii::t('global', 'SupplierComments'); ?> </h2>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'data'=>$model,
                    'attributes'=>array(
                    array('name'=>'supplier_id','value'=>$model->supplier->corporate_name),
                    array('name'=>'parent_id', 'value'=> SupplierComments::model()->getParentCategory( $model->parent_id ),'type'=>'raw'),
                    array('name'=>'subject'),
                    array('name'=>'author'),
