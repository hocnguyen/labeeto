...
<div class="span12">
    <div class="containerHeadline">
        <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','Supplier comments'); ?></h2>
    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <?php echo $form->errorSummary($model); ?>
                    ...
                    <div class="controls">
                        <?php
                        $listSuppliers  = CHtml::listData(Suppliers::model()->findAll(),'id','corporate_name');
                        echo $form->dropDownList($model,'supplier_id', $listSuppliers);
                        ?>
                    ...
                    <div class="controls">
                        ...
                        $list = CHtml::listData(SupplierComments::model()->findAllByAttributes($condition, $criteria ), 'id', 'subject' );
                    ...
                    <div class="controls">
                        <?php $this->widget('application.widgets.ckeditor.CKEditor', array( 'name' => 'SupplierComments[content]', 'value' => isset($model->content) ? $model->content : '', 'editorTemplate' => 'full' )); ?>
                    </div>
                </div>
                            <div class="control-group">
