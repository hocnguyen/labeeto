            ...
            <div class="containerHeadline tableHeadline">
                ...
                <form>
                    <div class="input-append">
                        <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('members/create') ?>'"><i class="icon-plus-sign" title="Create Member"></i></span>
                                    ...
                                    (
                                        ...
                                        (
                                            ...
                                            'options' => array( 'class' => 'tipb view-icon-tooltip',
                                                                'data-original-title' => Yii::t('adminlang', 'View member'),
                                                                'title'       => Yii::t('adminlang', 'View member'), ),
                                        ),
                                        'update' => array
                                        (
                                            ...
                                            'options' => array( 'class' => 'tipb update-icon-tooltip',
                                                                'data-original-title' => Yii::t('adminlang', 'Edit member'),
                                                                'title'       => Yii::t('adminlang', 'Edit member'), ),
                                        ),
                                        'delete' => array
                                        (
                                            ...
                                            'options' => array( 'class' => 'tipb delete-icon-tooltip',
                                                                'data-original-title' => Yii::t('adminlang', 'Delete member'),
                                                                'title'       => Yii::t('adminlang', 'Delete member'), ),
                                        ),
