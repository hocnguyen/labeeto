...
<div class="span12">
    <div class="containerHeadline">
        <i class="icon-ok-sign"></i><h2><?php echo Yii::t('global','maps'); ?></h2>
    ...
    <div class="floatingBox" style="display: block;">
        <div class="container-fluid">
            ...
            <div class="control-group">
                <label for="fullname" class="control-label"><?php echo $form->labelEx($model,'coords'); ?>
                </label>
                <div class="controls">
                    <?php echo $form->textField($model,'coords',array('size'=>60,'maxlength'=>255, 'class'=>'span10')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        $list   = array('departement'=>'departement','ville'=>'ville');
