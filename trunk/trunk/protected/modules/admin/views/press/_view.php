<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('newspaper_title')); ?>:</b>
	<?php echo CHtml::encode($data->newspaper_title); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('delFlg')); ?>:</b>
	<?php echo CHtml::encode($data->delFlg); ?>
	<br />
