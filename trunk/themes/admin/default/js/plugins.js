...
$(document).ready(function(){
   ...
   // TOOLTIPS
        ...
        // WYSIWIG HTML EDITOR    
         ...
         if($("#fmultiselect").length > 0 || $('#countriesSupported').length >0){
            $("#fmultiselect").multiSelect({
                selectableHeader: "<div class='multipleselect-header'>Supported Countries</div>",
                selectedHeader: "<div class='multipleselect-header'>Unsupported countries</div>"
            });
             $("#countriesSupported").multiSelect({
                 selectableHeader: "<div class='multipleselect-header'>Countries</div>",
                 selectedHeader: "<div class='multipleselect-header'>Countries supported</div>"
             });
            $('#multiselect-selectAll').click(function(){
                $('#fmultiselect').multiSelect('select_all');
                $('#countriesSupported').multiSelect('select_all');
                return false;
            });
            $('#multiselect-deselectAll').click(function(){
                $('#fmultiselect').multiSelect('deselect_all');
                $('#countriesSupported').multiSelect('deselect_all');
                return false;
            });
            $('#multiselect-selectIndia').click(function(){
                $('#fmultiselect').multiSelect('select', 'in');
                $('#countriesSupported').multiSelect('select', 'in');
                return false;
            });         
         }
    /* Multiselect */
    ...
    if($("#fmultiselect-card").length > 0 || $('#countriesSupported').length >0){
        $("#fmultiselect-card").multiSelect({
            selectableHeader: "<div class='multipleselect-header'>Supported card type</div>",
            selectedHeader: "<div class='multipleselect-header'>Unsupported card type</div>"
        });
        $("#countriesSupported").multiSelect({
            selectableHeader: "<div class='multipleselect-header'>Supported card type</div>",
            selectedHeader: "<div class='multipleselect-header'>Unsupported card type</div>"
        ...
        $('#multiselect-selectAll').click(function(){
            $('#fmultiselect-card').multiSelect('select_all');
            $('#countriesSupported').multiSelect('select_all');
            return false;
        });
        $('#multiselect-deselectAll').click(function(){
            $('#fmultiselect-card').multiSelect('deselect_all');
            $('#countriesSupported').multiSelect('deselect_all');
            return false;
        });
        $('#multiselect-selectIndia').click(function(){
            $('#fmultiselect-card').multiSelect('select', 'in');
            $('#countriesSupported').multiSelect('select', 'in');
            return false;
        });
    }
    ...
    if($("#fmultiselect-payment").length > 0 || $('#countriesSupported').length >0){
        $("#fmultiselect-payment").multiSelect({
            selectableHeader: "<div class='multipleselect-header'>Supported payment method</div>",
            selectedHeader: "<div class='multipleselect-header'>Unsupported payment method</div>"
        });
        $('#multiselect-selectAll').click(function(){
            $('#fmultiselect-payment').multiSelect('select_all');
            $('#countriesSupported').multiSelect('select_all');
            return false;
        });
        $('#multiselect-deselectAll').click(function(){
            $('#fmultiselect-payment').multiSelect('deselect_all');
            $('#countriesSupported').multiSelect('deselect_all');
            return false;
        });
        $('#multiselect-selectIndia').click(function(){
            $('#fmultiselect-payment').multiSelect('select', 'in');
            $('#countriesSupported').multiSelect('select', 'in');
            return false;
        });
    }
