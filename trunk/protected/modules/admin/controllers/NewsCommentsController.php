...
class NewsCommentsController extends AdminBaseController {
    public function init()
	{
		parent::init();
		
		$this->breadcrumbs[ Yii::t('global', 'News Comments') ] = array('newsComments/index');
		$this->pageTitle[] = Yii::t('global', 'News Comments');
	}
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['NewsComments']))
		{
            ...
            $model->parent_id = $_POST['NewsComments']['parent_id'];
			if($model->save())
	...
	{
		$model=NewsComments::model()->findByPk((int)$id);
		if($model===null)
