...
class ProducersController extends AdminBaseController {
    public function init()
	{
		parent::init();
		
		$this->breadcrumbs[ Yii::t('global', 'Producers') ] = array('producers/index');
		$this->pageTitle[] = Yii::t('global', 'Producers');
	}
	...
	{
		$model=Producers::model()->findByPk((int)$id);
		if($model===null)
