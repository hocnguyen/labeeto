...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'pictures'); ?>
		<?php echo $form->textField($model,'pictures',array('size'=>60,'maxlength'=>255, 'class'=>'span10')); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'is_home'); ?>
		<?php echo $form->textField($model,'is_home', array('class'=>'span10')); ?>
	</div>
