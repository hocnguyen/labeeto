...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('suppliers/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
		...
		array(
            'name'=>'advertiser',
            'value'=>'Suppliers::getStatus( $data->advertiser )',
            'filter'=>$advertiser,
        ),
		//'type',
		'address_1',
