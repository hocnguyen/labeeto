...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Announcement Categorys'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('announcementCategorys/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'id'=>'announcement-categorys-grid',
