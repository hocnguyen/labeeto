...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Supplier Products Comments'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('supplierProductsComments/create') ?>'"><i class="icon-plus-sign" title="Create supplier-products-comments"></i></span>
...
<div class="container-fluid">
    ...
    'id'=>'supplier-products-comments-grid',
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'new_title',
            'header'=>Yii::t('global','Name Product'),
