...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important">
       ...
       <small><?php echo Yii::t('global', 'SupplierProductsComments'); ?> #<?php echo $model->id; ?></small></h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline tableHeadline">
                ...
                <h2><?php echo Yii::t('global', 'SupplierProductsComments'); ?> </h2>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'data'=>$model,
                    'attributes'=>array(
                        array('name'=>'product_id','value'=>SupplierProductsComments::getTitleProduct( $model->product_id ), 'type'=>'raw' ),
                        array('name'=>'parent_id','value'=> SupplierProductsComments::model()->getParentCategory( $model->parent_id ),'type'=>'raw' ),
                        array('name'=>'subject'),
                        array('name'=>'author'),
