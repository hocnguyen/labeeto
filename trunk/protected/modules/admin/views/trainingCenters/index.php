...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Training Centers'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('trainingCenters/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            ...
            'type' => 'raw',
            'filter'=>$active_press,
            'value' => '$data->getStatusTrainingCenters($data->advertiser)',
            'htmlOptions'=>array('style'=>'width:90px;')
        ),
		array(
            'name'=>'name_type_of_training',
            'value'=>'$data->typeOfTraining->name',
            'type'=>'raw',
        ),
		'city_1',
        array(
