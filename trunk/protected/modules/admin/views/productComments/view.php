...
<div class="container-fluid">
    <div class="page-header" style="border-bottom: 0px solid !important">
       ...
       <small><?php echo Yii::t('global', 'ProductComments'); ?> #<?php echo $model->id; ?></small></h1>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="containerHeadline tableHeadline">
                ...
                <h2><?php echo Yii::t('global', 'ProductComments'); ?> </h2>
            ...
            <div class="floatingBox table table-view-user">
                <div class="container-fluid">
                    ...
                    'data'=>$model,
                    'attributes'=>array(
                    array('name'=>'product_id', 'value'=>ProductComments::getTitleProduct( $model->product_id ), 'type'=>'raw'),
                    array('name'=>'parent_id', 'value'=> ProductComments::model()->getParentCategory( $model->parent_id )),
                    array('name'=>'subject' ),
                    array('name'=>'author'),
                    array('name'=>'content', 'type'=>'html'),
                    array('name'=>'is_active', 'value'=>ProductComments::getStatusProductComments( $model->is_active ) ),
                    array('name'=>'created'),
                    array('name'=>'updated'),
                    ),
                    )); ?>
