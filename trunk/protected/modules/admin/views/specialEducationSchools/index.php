...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Special Education Schools'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('specialEducationSchools/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    <?php
    $advertiser = Utils::getStatusCommon();
    $this->widget('zii.widgets.grid.CGridView', array(
    'id'=>'special-education-schools-grid',
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'advertiser',
            'value'=>'SpecialEducationSchools::getStatus( $data->advertiser )',
            'filter'=>$advertiser,
        ),
		'phone_1',
		'fax',
