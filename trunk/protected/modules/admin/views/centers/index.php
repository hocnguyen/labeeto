...
<div class="containerHeadline tableHeadline">
    ...
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('centers/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            ...
            'type' => 'raw',
            'filter'=>$active_press,
            'value' => '$data->getStatusCenters($data->advertiser)',
