...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Supplier Products'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('supplierProducts/create') ?>'"><i class="icon-plus-sign" title="Create supplier-products"></i></span>
...
<div class="container-fluid">
    ...
    <?php
    $status_common = Utils::getStatusCommon();
    $this->widget('zii.widgets.grid.CGridView', array(
    'id'=>'supplier-products-grid',
    ...
    'columns'=>array(
		...
		array(
            'name'=>'is_activity',
            'value'=>'SupplierProducts::getStatus($data->is_activity)',
            'type'=>'raw',
            'filter'=>$status_common,
        ),
        array(
            'name'=>'is_brand',
            'value'=>'SupplierProducts::getStatus($data->is_brand)',
            'type'=>'raw',
            'filter'=>$status_common,
        ),
        array(
