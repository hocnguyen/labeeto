<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('publishing')); ?>:</b>
	<?php echo CHtml::encode($data->publishing); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('po_box_cedex_2')); ?>:</b>
	<?php echo CHtml::encode($data->po_box_cedex_2); ?>
	<br />
