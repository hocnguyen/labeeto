...
<div class="containerHeadline tableHeadline">
    <h2><?php echo Yii::t('global', 'Speech Therapists'); ?></h2>
    <form>
        <div class="input-append">
            <span class="add-on add-on-middle add-on-mini" onclick="window.location.href='<?php echo $this->createUrl('speechTherapist/create') ?>'"><i class="icon-plus-sign" title="Create"></i></span>
...
<div class="container-fluid">
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'advertisers',
            'value'=>'SpeechTherapist::getStatus( $data->advertisers )',
            'filter'=>$advertiser,
        ),
        array(
            'name' => 'created',
